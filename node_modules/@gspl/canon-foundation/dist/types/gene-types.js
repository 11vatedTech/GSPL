...
export const GENE_TYPES_COUNT = GENE_TYPES.length;
/**
 * Authoritative registry. Order follows the canonical ordering in `GENE_TYPES`.
 */
export const GENE_TYPE_REGISTRY = {
    scalar: {
        id: 'scalar',
...
export function isCanonicalGeneType(id) {
    return GENE_TYPES.includes(id);
}
//# sourceMappingURL=gene-types.js.map