...
export function isHashedField(fieldPath) {
 ...
 */
export function extractCanonicalHashMaterial(seed) {
    return {
        schema: seed.schema,
...
// ── Seed Creation ──
export function makePrimordialSeed(overrides) {
    const defaults = {
...
export function hashMaterialFromSeed(seed) {
