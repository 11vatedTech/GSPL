...
export const CANONICAL_UNICODE_FORM = 'NFKC';
...
export function isCanonicalNumber(n) {
 ...
 */
export function binaryRoundTrip(data) {
...
export function normalizeTimestamp(ts) {
    ...
    if (!normalized.endsWith("Z") && normalized.indexOf("+") === -1 && normalized.lastIndexOf("-") <= normalized.indexOf("T"))
        normalized += "Z";
    try {
...
export function serializeCanonicalNumber(n) {
