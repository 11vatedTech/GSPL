...
export type GeneTypeClassification = 'FUNDAMENTAL_VALUE_KIND' | 'COMPOSITE_STRUCTURE' | 'GRAPH_STRUCTURE' | 'DOMAIN_SPECIFIC_LIBRARY_TYPE' | 'OPERATOR_OR_RULE' | 'SECURITY_PRIMITIVE' | 'ANNOTATION' | 'METAPHOR_WITHOUT_DISTINCT_SEMANTICS' | 'RESEARCH_ONLY';
...
export type GeneOptionalCapability = 'mutation' | 'crossover' | 'distance' | 'interpolation' | 'sampling' | 'gradient' | 'optimization' | 'evolution' | 'visual-editing';
/** Migration behavior */
