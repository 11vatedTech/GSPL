...
export declare const GST_VERSION: GstVersion;
/** The .gseed file-format magic bytes. See spec/06-gseed-format.md. */
export declare const GSED_MAGIC = "GSED";
/**
 ...
 */
export declare const GENE_TYPES: readonly ["scalar", "categorical", "vector", "expression", "struct", "array", "graph", "topology", "temporal", "regulatory", "field", "symbolic", "quantum", "gematria", "resonance", "dimensional", "sovereignty"];
/**
 * INITIAL INVENTORY of 26 domain identifiers (spec/00). EXTENSIBLE per the
 * EXTENSIBILITY PROTOCOL.
 */
export declare const DOMAINS: readonly ["sprite", "character", "music", "fullgame", "animation", "procedural", "geometry3d", "narrative", "ui", "physics", "visual2d", "audio", "ecosystem", "game", "alife", "shader", "particle", "typography", "architecture", "vehicle", "furniture", "fashion", "robotics", "circuit", "food", "choreography"];
/**
 ...
 */
export declare const KEYWORDS: readonly ["seed", "breed", "mutate", "compose", "evolve", "grow", "export", "import", "let", "fn", "if", "else", "match", "for", "while", "return", "true", "false", "null", "type", "trait", "impl", "where", "gene", "domain", "signed"];
/**
 ...
 * substrate.
 */
export declare const SEVEN_AXES: readonly ["signed", "typed", "lineage-tracked", "graph-structured", "confidence-bearing", "rollback-able", "differentiable"];
