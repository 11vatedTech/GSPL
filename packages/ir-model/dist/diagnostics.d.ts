...
export type DiagnosticCategory = 'SCHEMA' | 'TYPE' | 'REFERENCE' | 'CONSTRAINT' | 'INVARIANT' | 'CAPABILITY' | 'EFFECT' | 'DETERMINISM' | 'CANONICALIZATION' | 'HASH' | 'GRAPH' | 'CYCLE' | 'RESOURCE' | 'VERSION' | 'MIGRATION' | 'SECURITY' | 'PROVENANCE' | 'TARGET' | 'EXTENSION' | 'INTERNAL';
...
export declare function provenanceChain(source: ProvenanceChain['source'], originId: string, transformation?: string): ProvenanceChain;
/** Default provenance when no better source exists */
export declare function defaultProvenance(): ProvenanceChain;
/** Create a diagnostic */
export declare function diagnostic(code: DiagnosticCode, severity: DiagnosticSeverity, category: DiagnosticCategory, message: string, overrides?: Partial<Diagnostic>): Diagnostic;
