 ...
 * Per Prompt 2 §6.
 */
export type { GeneTypeId, GeneTypeDescriptor, GeneTypeRegistry, GeneTypeClassification, GeneValueSchema, GeneCanonicalizer, GeneValidator, GeneNormalizer, GeneIrLowering, GeneCompositionSemantics, GeneMergeSemantics, GeneDiffSemantics, GeneOptionalCapability, GeneMigrationBehavior, GeneResourceEstimate, GeneEffectRequirement, ExtensibleGeneRegistry, ImmutableGeneRegistryConfig, } from './types.js';
...
export { RECOVERED_GENE_DISPOSITIONS, getDisposition, type GeneDisposition, type GeneDispositionRecord, } from './dispositions.js';
