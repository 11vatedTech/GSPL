 ...
 */
export const fixtureSoftwareArchitecture = makePrimordialSeed({
    namespace: {
 ...
 * reusable components.
 */
export const fixtureInteractiveScene = makePrimordialSeed({
    namespace: {
        domain: 'com.11vatedtech.fixtures',
 ...
 */
export const fixtureMixedVideoGame = makePrimordialSeed({
    namespace: {
        domain: 'com.11vatedtech.fixtures',
