...
export type IrNodeKind = 'value' | 'gene' | 'constraint' | 'invariant' | 'capability' | 'effect' | 'dependency' | 'reference' | 'region' | 'target' | 'entropy-channel' | 'resource-budget' | 'provenance' | 'diagnostic' | 'extension';
export type IrEdgeKind = 'contains' | 'references' | 'constrains' | 'depends-on' | 'produces' | 'requires' | 'entropy-forks-to' | 'lowers-to' | 'projects-to' | 'conflicts-with' | 'extends';
...
export declare const DEFAULT_IR_GRAPH_PROPERTIES: IrGraphProperties;
