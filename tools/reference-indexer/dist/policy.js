...
const EXTENSIONLESS_CLASSIFICATION = {
    'Dockerfile': 'config',
    'Makefile': 'config',
    'LICENSE': 'docs',
    'README': 'docs',
...
const PATH_PATTERN_CLASSIFICATION = [
    { match: /(^|\/)test\//, as: 'test' },
    { match: /(^|\/)tests\//, as: 'test' },
...
export function shouldExcludeFile(name) {
    if (EXCLUDED_BASENAMES.includes(name))
        return true;
